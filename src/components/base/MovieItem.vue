  ...
  <div class="movie-item">
    ...
    <div class="movie-item__info">
      <RouterLink :to="{ name: 'phim', params: { slug: movie.slug }, force: true }"
        :aria-label="`Xem phim ${movie.name}`" class="movie-item__title">
        <strong>{{ movie.name }}</strong>
      </RouterLink>
      <p class="movie-item__meta">{{ movie.description }}</p>
      <p class="movie-item__meta">{{ movie.time }}</p>
    ...
    <div v-if="movie.current_episode" class="movie-item__eps-tag">
